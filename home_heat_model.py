...
class HomeHeatModel(object):
    ...
    def __init__(self,
                 ...
                 temp_projection = 0, # added for temp projection 
    ...
    def export_total_kwh_to_csv(self, file_path):
        import pandas as pd
        """Export total_kwh data to a CSV file."""
        df_export = pd.DataFrame({'total_kwh': self.df_hourly['total_kwh']})
        df_export.to_csv(file_path, index_label='hour')
    ...
    def calculate(self):
        ...
        s.df_hourly = df_tmy[['db_temp']].copy() + s.temp_projection # adding temp projection
