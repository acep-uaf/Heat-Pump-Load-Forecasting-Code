...
class HP_model:
    ...
    def run(self):
        ...
        self.hourly_kwh_data = sim.df_hourly['total_kwh'].copy()
        self.hourly_hpkwh_data = sim.df_hourly['hp_kwh'].copy()
        self.hourly_seckwh_data = sim.df_hourly['secondary_kwh'].copy()
        ...
        # Newly added code: store temp data
